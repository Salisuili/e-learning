...
export const authService = {
  ...
  async register(
    ...
    try {
      ...
      // Add identification fields for students and lecturers
      if (data.role === "student" && data.identification_number) {
        newUser.identification_number = data.identification_number;
      }
      if (data.role === "lecturer" && data.identification_number) {
        newUser.identification_number = data.identification_number;
      }
      if (data.document_url) {
        newUser.document_url = data.document_url;
      }
      if (data.document_file_name) {
        newUser.document_file_name = data.document_file_name;
      }
