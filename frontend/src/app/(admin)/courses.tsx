...
export default function AdminCourses() {
  ...
  const getDeptColor = (dept: string) => {
    ...
    const idx = dept.length % colors.length;
    return colors[idx];
  };
  ...
  const renderCourseItem = ({ item, index }: { item: Course; index: number }) => {
    ...
    const deptColor = getDeptColor(item.department);
    const anim = cardAnimations.current[index];

    return (
      <Animated.View
        style={anim ? { opacity: anim, transform: [{ translateY: anim?.interpolate({ inputRange: [0, 1], outputRange: [20, 0] }) }] } : {}}
      >
        <TouchableOpacity
          activeOpacity={0.7}
        ...
        >
          ...
          >
            ...
            <View style={styles.cardHeader}>
              <View style={[styles.codeBadge, { backgroundColor: deptColor + '20' }]}>
                <Text style={[styles.codeText, { color: deptColor }]}>
                  {item.code}
                </Text>
              </View>
              <View style={styles.cardActions}>
                <TouchableOpacity
                  style={[styles.cardIconBtn, { backgroundColor: theme.primary + '12' }]}
                  onPress={() => openEditModal(item)}
                >
                  <Ionicons name="create-outline" size={16} color={theme.primary} />
                </TouchableOpacity>
                <TouchableOpacity
                  style={[styles.cardIconBtn, { backgroundColor: theme.error + '12' }]}
                  onPress={() => confirmDelete(item)}
                >
            ...
            <View style={styles.cardMetaRow}>
              <View style={[styles.creditBadge, { backgroundColor: theme.warning + '20' }]}>
              ...
              <View style={styles.semesterBadge}>
                ...
                <Text style={[styles.semesterText, { color: theme.textSecondary }]}>
            ...
            >
              ...
              <View style={styles.detailSection}>
                ...
                >
                  ...
                  {selectedCourse.updated_at && (
                    <View
                      style={[styles.detailDateRow, { marginTop: 8 }]}
                    >
                      <Ionicons
              ...
              <View style={styles.detailActions}>
                ...
                >
                  ...
                  <Text style={styles.detailActionBtnText}>Edit Course</Text>
                </TouchableOpacity>

                <TouchableOpacity
                  style={[styles.detailActionBtn, { backgroundColor: theme.error }]}
                  onPress={() => confirmDelete(selectedCourse)}
                >
                  <Ionicons name="trash-outline" size={20} color="#fff" />
                  <Text style={styles.detailActionBtnText}>Delete Course</Text>
                </TouchableOpacity>
              </View>
            </ScrollView>
          </SafeAreaView>
